...
class Pluto:
    ...
    def Heating(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 2. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 2. * self.pi * self.q_EUVmean_const * q_r_N2
...
PhiPhiE_SolarMin = np.loadtxt('phiphiElamb_SolarMin_05dr.ascii')
phi_0 = PhiPhiE_SolarMin[0]
phiE_0 = PhiPhiE_SolarMin[1]
Exobase_SolarMin = np.loadtxt('ExobaseVals_SolarMin_05dr.ascii')
i0_x = int(Exobase_SolarMin[0])
NumTempRadVel_SolarMin = np.loadtxt('NumTempRadVel_SolarMin_05dr.ascii')
n0 = NumTempRadVel_SolarMin[0,:]
r0 = NumTempRadVel_SolarMin[1,:]
T0 = NumTempRadVel_SolarMin[2,:]
Convergence_SolarMin = np.loadtxt('Convergence_SolarMin_05dr.ascii')
TIME_SolarMin = Convergence_SolarMin[0]
iteration_SolarMin = Convergence_SolarMin[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = PlutoProj.convergence_iteration(i0_x, n0, r0, T0, 12.*phi_0, 12.*phiE_0)


phi_old = 12.*phi_0
phiE_old = 12.*phiE_0
phi_old_avg = 12.*phi_0
phiE_old_avg = 12.*phiE_0
...
TIME = TIME + TIME_SolarMin
iteration = iteration + iteration_SolarMin
...
T_SolarMean = T
u_SolarMean = u
phi_SolarMean = phi_new
phiE_SolarMean = phiE_new
lamb_x_SolarMean = lamb_x


Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_SolarMean_05dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_SolarMean, T_SolarMean, r_SolarMean, u_SolarMean]
phiphiElamb_Results = [phi_SolarMean, phiE_SolarMean, lamb_x_SolarMean]
Exobase_Results = [i_x_SolarMean, n_x_SolarMean, r_x_SolarMean, T_x_SolarMean]
np.savetxt('NumTempRadVel_SolarMean_05dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_SolarMean_05dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_SolarMean_05dr.ascii', Exobase_Results)
...
class Pluto:
    ...
    def Heating(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 4. * self.pi * self.q_UVmax_const * q_r_CH4
            Q_N2[k] = 4. * self.pi * self.q_EUVmax_const * q_r_N2
...
PhiPhiE_145SolarMean = np.loadtxt('phiphiElamb_145SolarMean_1dr.ascii')
phi_0 = PhiPhiE_145SolarMean[0]
phiE_0 = PhiPhiE_145SolarMean[1]
Exobase_145SolarMean = np.loadtxt('ExobaseVals_145SolarMean_1dr.ascii')
i0_x = int(Exobase_145SolarMean[0])
NumTempRadVel_145SolarMean = np.loadtxt('NumTempRadVel_145SolarMean_1dr.ascii')
n0 = NumTempRadVel_145SolarMean[0,:]
r0 = NumTempRadVel_145SolarMean[1,:]
T0 = NumTempRadVel_145SolarMean[2,:]
Convergence_145SolarMean = np.loadtxt('Convergence_145SolarMean_1dr.ascii')
TIME_145SolarMean = Convergence_145SolarMean[0]
iteration_145SolarMean = Convergence_145SolarMean[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = PlutoProj.convergence_iteration(i0_x, n0, r0, T0, phi_0, phiE_0)
...
T_SolarMax = T
u_SolarMax = u
phi_SolarMax = phi_new
phiE_SolarMax = phiE_new
lamb_x_SolarMax = lamb_x


Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_SolarMax_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_SolarMax, T_SolarMax, r_SolarMax, u_SolarMax]
phiphiElamb_Results = [phi_SolarMax, phiE_SolarMax, lamb_x_SolarMax]
Exobase_Results = [i_x_SolarMax, n_x_SolarMax, r_x_SolarMax, T_x_SolarMax]
np.savetxt('NumTempRadVel_SolarMax_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_SolarMax_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_SolarMax_1dr.ascii', Exobase_Results)
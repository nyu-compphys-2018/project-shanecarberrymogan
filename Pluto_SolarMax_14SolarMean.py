...
class Pluto:
    ...
    def Iterative_Heating_14SolarMean(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.4 * 4. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 1.4 * 4. * self.pi * self.q_EUVmean_const * q_r_N2
    ...
    def convergence_iteration_14SolarMean(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_14SolarMean(i_Kn01, n, tau_CH4, tau_N2)
...
PhiPhiE_135SolarMean = np.loadtxt('phiphiElamb_135SolarMean_1dr.ascii')
phi_0 = PhiPhiE_135SolarMean[0]
phiE_0 = PhiPhiE_135SolarMean[1]
Exobase_135SolarMean = np.loadtxt('ExobaseVals_135SolarMean_1dr.ascii')
i0_x = int(Exobase_135SolarMean[0])
NumTempRadVel_135SolarMean = np.loadtxt('NumTempRadVel_135SolarMean_1dr.ascii')
n0 = NumTempRadVel_135SolarMean[0,:]
r0 = NumTempRadVel_135SolarMean[1,:]
T0 = NumTempRadVel_135SolarMean[2,:]
Convergence_135SolarMean = np.loadtxt('Convergence_135SolarMean_1dr.ascii')
TIME_135SolarMean = Convergence_135SolarMean[0]
iteration_135SolarMean = Convergence_135SolarMean[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_14SolarMean(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    PlutoProj.convergence_iteration_14SolarMean(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
TIME = TIME + TIME_135SolarMean

iteration = iteration + iteration_135SolarMean
...
T_14SolarMean = T
u_14SolarMean = u
phi_14SolarMean = phi_new
phiE_14SolarMean = phiE_new
lamb_x_14SolarMean = lamb_x

Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_14SolarMean_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_14SolarMean, T_14SolarMean, r_14SolarMean, u_14SolarMean]
phiphiElamb_Results = [phi_14SolarMean, phiE_14SolarMean, lamb_x_14SolarMean]
Exobase_Results = [i_x_14SolarMean, n_x_14SolarMean, r_x_14SolarMean, T_x_14SolarMean]
np.savetxt('NumTempRadVel_14SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_14SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_14SolarMean_1dr.ascii', Exobase_Results)
...
class Pluto:
    ...
    def Iterative_Heating_125SolarMean(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.25 * 4. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 1.25 * 4. * self.pi * self.q_EUVmean_const * q_r_N2
    ...
    def convergence_iteration_125SolarMean(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_125SolarMean(i_Kn01, n, tau_CH4, tau_N2)
...
PhiPhiE_12SolarMean = np.loadtxt('phiphiElamb_12SolarMean_1dr.ascii')
phi_0 = PhiPhiE_12SolarMean[0]
phiE_0 = PhiPhiE_12SolarMean[1]
Exobase_12SolarMean = np.loadtxt('ExobaseVals_12SolarMean_1dr.ascii')
i0_x = int(Exobase_12SolarMean[0])
NumTempRadVel_12SolarMean = np.loadtxt('NumTempRadVel_12SolarMean_1dr.ascii')
n0 = NumTempRadVel_12SolarMean[0,:]
r0 = NumTempRadVel_12SolarMean[1,:]
T0 = NumTempRadVel_12SolarMean[2,:]
Convergence_12SolarMean = np.loadtxt('Convergence_12SolarMean_1dr.ascii')
TIME_12SolarMean = Convergence_12SolarMean[0]
iteration_12SolarMean = Convergence_12SolarMean[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_125SolarMean(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    PlutoProj.convergence_iteration_125SolarMean(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
TIME = TIME + TIME_12SolarMean

iteration = iteration + iteration_12SolarMean


i_x_125SolarMean = i_x
n_x_125SolarMean = n_x
r_x_125SolarMean = r_x
T_x_125SolarMean = T_x
n_125SolarMean = n
r_125SolarMean = r
T_125SolarMean = T
u_125SolarMean = u
phi_125SolarMean = phi_new
phiE_125SolarMean = phiE_new
lamb_x_125SolarMean = lamb_x

Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_125SolarMean_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_125SolarMean, T_125SolarMean, r_125SolarMean, u_125SolarMean]
phiphiElamb_Results = [phi_125SolarMean, phiE_125SolarMean, lamb_x_125SolarMean]
Exobase_Results = [i_x_125SolarMean, n_x_125SolarMean, r_x_125SolarMean, T_x_125SolarMean]
np.savetxt('NumTempRadVel_125SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_125SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_125SolarMean_1dr.ascii', Exobase_Results)
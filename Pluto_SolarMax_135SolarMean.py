...
class Pluto:
    ...
    def Iterative_Heating_135SolarMean(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.35 * 4. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 1.35 * 4. * self.pi * self.q_EUVmean_const * q_r_N2
    ...
    def convergence_iteration_135SolarMean(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_135SolarMean(i_Kn01, n, tau_CH4, tau_N2)
...
PhiPhiE_13SolarMean = np.loadtxt('phiphiElamb_13SolarMean_1dr.ascii')
phi_0 = PhiPhiE_13SolarMean[0]
phiE_0 = PhiPhiE_13SolarMean[1]
Exobase_13SolarMean = np.loadtxt('ExobaseVals_13SolarMean_1dr.ascii')
i0_x = int(Exobase_13SolarMean[0])
NumTempRadVel_13SolarMean = np.loadtxt('NumTempRadVel_13SolarMean_1dr.ascii')
n0 = NumTempRadVel_13SolarMean[0,:]
r0 = NumTempRadVel_13SolarMean[1,:]
T0 = NumTempRadVel_13SolarMean[2,:]
Convergence_13SolarMean = np.loadtxt('Convergence_13SolarMean_1dr.ascii')
TIME_13SolarMean = Convergence_13SolarMean[0]
iteration_13SolarMean = Convergence_13SolarMean[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_135SolarMean(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    PlutoProj.convergence_iteration_135SolarMean(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
TIME = TIME + TIME_13SolarMean

iteration = iteration + iteration_13SolarMean


i_x_135SolarMean = i_x
n_x_135SolarMean = n_x
r_x_135SolarMean = r_x
T_x_135SolarMean = T_x
n_135SolarMean = n
r_135SolarMean = r
T_135SolarMean = T
u_135SolarMean = u
phi_135SolarMean = phi_new
phiE_135SolarMean = phiE_new
lamb_x_135SolarMean = lamb_x

Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_135SolarMean_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_135SolarMean, T_135SolarMean, r_135SolarMean, u_135SolarMean]
phiphiElamb_Results = [phi_135SolarMean, phiE_135SolarMean, lamb_x_135SolarMean]
Exobase_Results = [i_x_135SolarMean, n_x_135SolarMean, r_x_135SolarMean, T_x_135SolarMean]
np.savetxt('NumTempRadVel_135SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_135SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_135SolarMean_1dr.ascii', Exobase_Results)
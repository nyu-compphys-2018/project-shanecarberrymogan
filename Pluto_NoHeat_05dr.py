...
np.savetxt('Convergence_NoHeat_05dr.ascii', Convergence_Results)
np.savetxt('NumTempRadVel_NoHeat_05dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_NoHeat_05dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_NoHeat_05dr.ascii', Exobase_Results)
...
class Pluto:
    ...
    def init_cond(self, kB = Boltzmann, T0 = 88.2, M_P = 1.309E22, \
     ...
     F_EUV_min=1.7E-4, F_EUV_mean=2.9E-4, F_EUV_max=4.9E-4):
        ...
        self.F_EUV_mean = F_UV_mean/1E3
        self.F_EUV_max = F_UV_max/1E3
...
Phi_FirstIt = np.loadtxt('phiphiE_SolarMin_1dr_FirstIt.ascii')
phi_0 = Phi_FirstIt[0]
phiE_0 = Phi_FirstIt[1]
phi_1 = Phi_FirstIt[2]
phiE_1 = Phi_FirstIt[3]
Exobase_FirstIt = np.loadtxt('Exobase_SolarMin_1dr_FirstIt.ascii')
i1_x = int(Exobase_FirstIt[1])
TIME_FirstIt = Exobase_FirstIt[0]
NumTempRadVel = np.loadtxt('NumTempRadVel_SolarMin_1dr_FirstIt.ascii')
n1 = NumTempRadVel[0,:]
r1 = NumTempRadVel[1,:]
T1 = NumTempRadVel[2,:]
...
np.savetxt('Convergence_SolarMin_1dr.ascii', Convergence_Results)
np.savetxt('NumTempRadVel_SolarMin_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_SolarMin_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_SolarMin_1dr.ascii', Exobase_Results)
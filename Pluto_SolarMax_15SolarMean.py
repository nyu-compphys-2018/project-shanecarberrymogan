...
class Pluto:
    ...
    def Iterative_Heating_15SolarMean(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.5 * 4. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 1.5 * 4. * self.pi * self.q_EUVmean_const * q_r_N2
    ...
    def convergence_iteration_15SolarMean(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_15SolarMean(i_Kn01, n, tau_CH4, tau_N2)
...
i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_15SolarMean(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    PlutoProj.convergence_iteration_15SolarMean(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
T_15SolarMean = T
u_15SolarMean = u
phi_15SolarMean = phi_new
phiE_15SolarMean = phiE_new
lamb_x_15SolarMean = lamb_x

Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_15SolarMean_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_15SolarMean, T_15SolarMean, r_15SolarMean, u_15SolarMean]
phiphiElamb_Results = [phi_15SolarMean, phiE_15SolarMean, lamb_x_15SolarMean]
Exobase_Results = [i_x_15SolarMean, n_x_15SolarMean, r_x_15SolarMean, T_x_15SolarMean]
np.savetxt('NumTempRadVel_15SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_15SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_15SolarMean_1dr.ascii', Exobase_Results)
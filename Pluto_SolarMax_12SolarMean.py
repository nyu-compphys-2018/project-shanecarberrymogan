...
class Pluto:
    ...
    def Iterative_Heating_12SolarMean(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.2 * 4. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 1.2 * 4. * self.pi * self.q_EUVmean_const * q_r_N2
    ...
    def convergence_iteration_12SolarMean(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_12SolarMean(i_Kn01, n, tau_CH4, tau_N2)
...
PhiPhiE_11SolarMean = np.loadtxt('phiphiElamb_11SolarMean_1dr.ascii')
phi_0 = PhiPhiE_11SolarMean[0]
phiE_0 = PhiPhiE_11SolarMean[1]
Exobase_11SolarMean = np.loadtxt('ExobaseVals_11SolarMean_1dr.ascii')
i0_x = int(Exobase_11SolarMean[0])
NumTempRadVel_11SolarMean = np.loadtxt('NumTempRadVel_11SolarMean_1dr.ascii')
n0 = NumTempRadVel_11SolarMean[0,:]
r0 = NumTempRadVel_11SolarMean[1,:]
T0 = NumTempRadVel_11SolarMean[2,:]
Convergence_11SolarMean = np.loadtxt('Convergence_11SolarMean_1dr.ascii')
TIME_11SolarMean = Convergence_11SolarMean[0]
iteration_11SolarMean = Convergence_11SolarMean[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_12SolarMean(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    PlutoProj.convergence_iteration_12SolarMean(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
TIME = TIME + TIME_11SolarMean

iteration = iteration + iteration_11SolarMean
...
T_12SolarMean = T
u_12SolarMean = u
phi_12SolarMean = phi_new
phiE_12SolarMean = phiE_new
lamb_x_12SolarMean = lamb_x

Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_12SolarMean_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_12SolarMean, T_12SolarMean, r_12SolarMean, u_12SolarMean]
phiphiElamb_Results = [phi_12SolarMean, phiE_12SolarMean, lamb_x_12SolarMean]
Exobase_Results = [i_x_12SolarMean, n_x_12SolarMean, r_x_12SolarMean, T_x_12SolarMean]
np.savetxt('NumTempRadVel_12SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_12SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_12SolarMean_1dr.ascii', Exobase_Results)
...
class Pluto:
    ...
    def Iterative_Heating_135SolarMin(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.35 * 4. * self.pi * self.q_UVmin_const * q_r_CH4
            Q_N2[k] = 1.35 * 4. * self.pi * self.q_EUVmin_const * q_r_N2
    ...
    def convergence_iteration_SolarMinToMaxIteration135(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_135SolarMin(i_Kn01, n, tau_CH4, tau_N2)
...
PhiPhiE_SolarMin = np.loadtxt('phiphiElamb_SolarMin_1dr.ascii')
phi_0 = PhiPhiE_SolarMin[0]
phiE_0 = PhiPhiE_SolarMin[1]
Exobase_SolarMin = np.loadtxt('ExobaseVals_SolarMin_1dr.ascii')
i0_x = int(Exobase_SolarMin[0])
NumTempRadVel_SolarMin = np.loadtxt('NumTempRadVel_SolarMin_1dr.ascii')
n0 = NumTempRadVel_SolarMin[0,:]
r0 = NumTempRadVel_SolarMin[1,:]
T0 = NumTempRadVel_SolarMin[2,:]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_SolarMinToMaxIteration135(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    i_x, n_x, r_x, T_x, n, r, T, u, phi_new, phiE_new, lamb_x = \
        PlutoProj.convergence_iteration_SolarMinToMaxIteration135(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
T_135SolarMin = T
u_135SolarMin = u
phi_135SolarMin = phi_new
phiE_135SolarMin = phiE_new
lamb_x_135SolarMin = lamb_x


Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_135SolarMin_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_135SolarMin, T_135SolarMin, r_135SolarMin, u_135SolarMin]
phiphiElamb_Results = [phi_135SolarMin, phiE_135SolarMin, lamb_x_135SolarMin]
Exobase_Results = [i_x_135SolarMin, n_x_135SolarMin, r_x_135SolarMin, T_x_135SolarMin]
np.savetxt('NumTempRadVel_135SolarMin_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_135SolarMin_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_135SolarMin_1dr.ascii', Exobase_Results)
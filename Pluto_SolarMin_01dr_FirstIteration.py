...
np.savetxt('Exobase_SolarMin_01dr_FirstIt.ascii', Exobase_Vals)
np.savetxt('HeatVals_SolarMin_01dr_FirstIt.ascii', Heat_Vals)
np.savetxt('NumTempRadVel_SolarMin_01dr_FirstIt.ascii', NumTempRadVel_Vals)
np.savetxt('phiphiE_SolarMin_01dr_FirstIt.ascii', PhiPhiE_01_Vals)
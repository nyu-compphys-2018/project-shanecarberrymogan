...
np.savetxt('Convergence_NoHeat_1dr.ascii', Convergence_Results)
np.savetxt('NumTempRadVel_NoHeat_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_NoHeat_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_NoHeat_1dr.ascii', Exobase_Results)
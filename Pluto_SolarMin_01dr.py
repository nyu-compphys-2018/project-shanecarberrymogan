...
Phi_FirstIt = np.loadtxt('phiphiE_SolarMin_01dr_FirstIt.ascii')
phi_0 = Phi_FirstIt[0]
phiE_0 = Phi_FirstIt[1]
phi_1 = Phi_FirstIt[2]
phiE_1 = Phi_FirstIt[3]
Exobase_FirstIt = np.loadtxt('Exobase_SolarMin_01dr_FirstIt.ascii')
i1_x = int(Exobase_FirstIt[1])
TIME_FirstIt = Exobase_FirstIt[0]
NumTempRadVel = np.loadtxt('NumTempRadVel_SolarMin_01dr_FirstIt.ascii')
n1 = NumTempRadVel[0,:]
r1 = NumTempRadVel[1,:]
T1 = NumTempRadVel[2,:]
...
np.savetxt('Convergence_SolarMin_01dr.ascii', Convergence_Results)
np.savetxt('NumTempRadVel_SolarMin_01dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_SolarMin_01dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_SolarMin_01dr.ascii', Exobase_Results)
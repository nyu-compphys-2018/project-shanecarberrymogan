...
class Pluto:
    ...
    def Iterative_Heating_13SolarMean(self, i, n, tau_CH4, tau_N2):
        ...
        for k in range(1, i+1):
            ...
            Q_CH4[k] = 1.3 * 4. * self.pi * self.q_UVmean_const * q_r_CH4
            Q_N2[k] = 1.3 * 4. * self.pi * self.q_EUVmean_const * q_r_N2
    ...
    def convergence_iteration_13SolarMean(self, i_x, n, r, T, phi, phiE):
        i_Kn01 = self.i_Kn01(i_x, n, r, T)
        tau_CH4, tau_N2 = self.Tau(i_Kn01, n)
        Q0_CH4, Qr_CH4, Q0_N2, Qr_N2 = self.Iterative_Heating_13SolarMean(i_Kn01, n, tau_CH4, tau_N2)
...
PhiPhiE_125SolarMean = np.loadtxt('phiphiElamb_125SolarMean_1dr.ascii')
phi_0 = PhiPhiE_125SolarMean[0]
phiE_0 = PhiPhiE_125SolarMean[1]
Exobase_125SolarMean = np.loadtxt('ExobaseVals_125SolarMean_1dr.ascii')
i0_x = int(Exobase_125SolarMean[0])
NumTempRadVel_125SolarMean = np.loadtxt('NumTempRadVel_125SolarMean_1dr.ascii')
n0 = NumTempRadVel_125SolarMean[0,:]
r0 = NumTempRadVel_125SolarMean[1,:]
T0 = NumTempRadVel_125SolarMean[2,:]
Convergence_125SolarMean = np.loadtxt('Convergence_125SolarMean_1dr.ascii')
TIME_125SolarMean = Convergence_125SolarMean[0]
iteration_125SolarMean = Convergence_125SolarMean[1]


i1_x, n1_x, r1_x, T1_x, n1, r1, T1, u1, phi_1, phiE_1, lamb_x = \
    PlutoProj.convergence_iteration_13SolarMean(i0_x, n0, r0, T0, phi_0, phiE_0)
...
while np.fabs(100.*(phi_new-phi_old)/(phi_old)) > 3.0:
    ...
    PlutoProj.convergence_iteration_13SolarMean(ix_old, n_old, r_old, T_old, phi_old_avg, phiE_old_avg)
...
TIME = TIME + TIME_125SolarMean

iteration = iteration + iteration_125SolarMean
...
T_13SolarMean = T
u_13SolarMean = u
phi_13SolarMean = phi_new
phiE_13SolarMean = phiE_new
lamb_x_13SolarMean = lamb_x

Convergence_Results = [TIME, iteration]
np.savetxt('Convergence_13SolarMean_1dr.ascii', Convergence_Results)

NumTempRadVel_Results = [n_13SolarMean, T_13SolarMean, r_13SolarMean, u_13SolarMean]
phiphiElamb_Results = [phi_13SolarMean, phiE_13SolarMean, lamb_x_13SolarMean]
Exobase_Results = [i_x_13SolarMean, n_x_13SolarMean, r_x_13SolarMean, T_x_13SolarMean]
np.savetxt('NumTempRadVel_13SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_13SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_13SolarMean_1dr.ascii', Exobase_Results)
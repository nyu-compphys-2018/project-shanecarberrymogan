...
PhiPhiE_135SolarMin = np.loadtxt('phiphiElamb_135SolarMin_1dr.ascii')
phi_0 = PhiPhiE_135SolarMin[0]
phiE_0 = PhiPhiE_135SolarMin[1]
Exobase_135SolarMin = np.loadtxt('ExobaseVals_135SolarMin_1dr.ascii')
i0_x = int(Exobase_135SolarMin[0])
NumTempRadVel_135SolarMin = np.loadtxt('NumTempRadVel_135SolarMin_1dr.ascii')
n0 = NumTempRadVel_135SolarMin[0,:]
r0 = NumTempRadVel_135SolarMin[1,:]
T0 = NumTempRadVel_135SolarMin[2,:]
Convergence_135SolarMin = np.loadtxt('Convergence_135SolarMin_1dr.ascii')
TIME_135SolarMin = Convergence_135SolarMin[0]
iteration_135SolarMin = Convergence_135SolarMin[1]
...
TIME = TIME + TIME_135SolarMin
iteration = iteration + iteration_135SolarMin
...
np.savetxt('Convergence_SolarMean_1dr.ascii', Convergence_Results)
...
np.savetxt('NumTempRadVel_SolarMean_1dr.ascii', NumTempRadVel_Results)
np.savetxt('phiphiElamb_SolarMean_1dr.ascii', phiphiElamb_Results)
np.savetxt('ExobaseVals_SolarMean_1dr.ascii', Exobase_Results)